...
midWithSort :: Int -> Int -> Int -> Int
midWithSort x y z = sort [x,y,z] !! 1
...
isVowelWithoutGuards :: Char -> Bool
isVowelWithoutGuards c = c `elem` "aeiou"
...
-}
firstDigit :: Int -> Int
firstDigit n = if value < 10 then value else firstDigit (value `div` 10)
  where value = abs n
